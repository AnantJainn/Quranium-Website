  ...
  return (
    <footer className="bg-black text-white">
      ...
      <div className="container mx-auto px-6 py-12 flex flex-col lg:flex-row items-center lg:items-start gap-12">
        ...
        <div className="flex-shrink-0 text-center lg:text-left lg:w-1/4 space-y-4">
          <Link href="/" className="inline-block">
            <img src="/Quranium-white.png" alt="Quranium" className="h-10" />
          </Link>
          <p className="text-sm text-gray-300">
            Sign up to our e-newsletter, <strong className="text-white">Quranium Pulse</strong>.
          </p>
          <Link
            href="#"
            className="inline-flex items-center justify-center px-6 py-3 border-2 border-red-600 text-red-600 rounded-lg hover:bg-red-900 hover:text-red-400 transition"
          >
            SUBSCRIBE NOW&nbsp;<span className="text-xl">→</span>
          </Link>

          <div className="flex flex-wrap items-center gap-6 mt-6 justify-center lg:justify-start ">
            <img src="/quantumminds.svg" alt="Quantum Minds" className="h-8" />
            <img src="/nextgen.svg" alt="NextGen Innovators" className="h-8" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 flex-1">
          ...
          <div className="space-y-4">
            ...
            <FooterColumn
              title="Career"
              links={[{ label: 'Join Our Team', href: '/careers' }]}
            />
          </div>
        </div>
      </div>
