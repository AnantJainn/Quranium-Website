...
//           Quranium&apos;s Uncrackable Journey
//         </h2>
...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="text-3xl max-w-7xl mx-auto py-2 px-4 md:px-8 lg:px-10">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-2">
        {data.map((item, index) => (
          ...
          >
            {/* Marker & Title */}
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 w-10 rounded-full bg-gray-900 flex items-center justify-center">
